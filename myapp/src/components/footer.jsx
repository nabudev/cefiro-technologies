      ...
      <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
        <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
          <div className="md:w-[316px]">
              <h1 className="text-white font-extrabold">
                <span className="text-[#61dafb]">CEFIRO</span> TECHNOLOGIES
              </h1>
            <p className="mt-[18px] text-[15px] font-normal text-white/[80%]">
              Creamos soluciones que impulsan el crecimiento de tu proyecto, negocio o empresa.
            </p>
            <div className="mt-[18px] flex gap-4">
              <img width="150" height="150" src="img/logosinfondo.webp" alt="Logo" />      
            </div>
          </div>
          <div className="md:w-[316px]">
            ...
            <div className="mt-[23px] flex">
              ...
              <div className="ml-[18px]">
                <a href="mailto:cefirotechnologies@gmail.com" className="font-Inter text-[14px] font-medium text-[#fff]">
                  Contactanos
                </a>
                <p className="font-Inter text-[12px] font-medium text-[#fff]">Vía email</p>
              </div>
            </div>
            <div className="mt-[23px] flex">
              <div className="flex h-[38px] w-[38px] items-center justify-center rounded-[75%]">
          ...
          <div className="mt-6 flex w-full flex-col justify-between text-white sm:flex-row md:mt-0 md:max-w-[341px]">
            <div className="">
              <p className="text-deutziawhite font-inter text-[18px] font-medium leading-normal">Navegar</p>
              <ul>
            ...
            <div className="mt-6 flex flex-col gap-4 sm:mt-0">
              <p className="text-deutziawhite font-inter text-[18px] font-medium">Seguinos</p>
              <div className="flex gap-4 sm:flex-col">
                <a target="_blank" href="https://www.instagram.com/cefirotechs/" rel="noreferrer">
                  <img
                    ...
                    src="https://img.icons8.com/?size=100&id=5eT5OnLluNOx&format=png&color=000000"
                  />
                </a>
              </div>
            </div>
        ...
        <div className="flex items-center justify-center pb-8 pt-[9px] md:py-8">
          <p className="text-[10px] font-normal text-white md:text-[12px]">
            © Copyright {new Date().getFullYear()}, All Rights Reserved by Cefiro Technologies.
          </p>
        </div>
      </div>
    </div>
